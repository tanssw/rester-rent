            ...
            <div class="modal-content">
                <div class="modal-body p-5">
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            <img :src="theme.image" class="image ratio ratio-4x3 rounded-3"/>
                        </div>
                    </div>
                    <div class="mb-5">
                        <h4 class="mb-3">รายการของประกอบฉาก</h4>
                        <div class="row">
                            <div v-for="(item, index) in accessory" :key="index" class="col-6">
                                <div class="row">
                                    <div class="col-3">
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        <h4 class="fw-light me-4 mb-0">
                            {{theme.price}} {{accessory.quantity}}
                            <span class="small">บาท</span>
                        </h4>
                        <button @click="confirmSelect" class="btn btn-emerald px-5 py-2">เลือก</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    mounted() {
        const element = document.getElementById('themeInfoModal')
